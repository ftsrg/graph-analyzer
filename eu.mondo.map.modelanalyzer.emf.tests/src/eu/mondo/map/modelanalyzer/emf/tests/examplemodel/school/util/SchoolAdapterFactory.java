/**
 */
package eu.mondo.map.modelanalyzer.emf.tests.examplemodel.school.util;

import eu.mondo.map.modelanalyzer.emf.tests.examplemodel.school.*;
...
public class SchoolAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link eu.mondo.map.modelanalyzer.emf.tests.examplemodel.school.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link eu.mondo.map.modelanalyzer.emf.tests.examplemodel.school.Student <em>Student</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link eu.mondo.map.modelanalyzer.emf.tests.examplemodel.school.Teacher <em>Teacher</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link eu.mondo.map.modelanalyzer.emf.tests.examplemodel.school.Container <em>Container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
