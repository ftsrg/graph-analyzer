...
public class TypedClusteringCoefficientDef3Test extends GraphMetricTest<ListData<Double>> {
        ...
        switch (modelType) {
            ...
            case Motif5N_2_3T:
                checker = (data) -> {
                    ...
                    checkAppearance(1, 1.0 / 6.0, data);
                    checkAppearance(1, 1.0 / 3.0, data);
                    checkAppearance(1, 1.0 / 9.0, data);
