package eu.mondo.map.calc.emf.test;
...
import eu.mondo.map.calc.emf.metrics.EMFDegreeList;
import eu.mondo.map.calc.emf.metrics.EMFNumberOfEdges;
import eu.mondo.map.core.metrics.models.NumberOfEdges;

public class EMFNumberOfEdgesTester extends EMFMetricTester {
	...
	public EMFNumberOfEdgesTester(String modelPath, String key) {
		super(modelPath, key);
	}
