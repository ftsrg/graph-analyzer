 ...
 * </p>
 * <ul>
 *   <li>{@link eu.mondo.map.tests.model.emf.network.impl.NodeImpl#getDim1 <em>Dim1</em>}</li>
 *   <li>{@link eu.mondo.map.tests.model.emf.network.impl.NodeImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.mondo.map.tests.model.emf.network.impl.NodeImpl#getDim2 <em>Dim2</em>}</li>
 *   <li>{@link eu.mondo.map.tests.model.emf.network.impl.NodeImpl#getDim3 <em>Dim3</em>}</li>
 * </ul>
 *
 * @generated
 */
