/**
 */
package eu.mondo.map.tests.model.emf.network.util;

import eu.mondo.map.tests.model.emf.network.*;
...
public class NetworkAdapterFactory extends AdapterFactoryImpl {
        ...
        /**
         * Creates a new adapter for an object of class '{@link eu.mondo.map.tests.model.emf.network.NodeContainer <em>Node Container</em>}'.
         * <!-- begin-user-doc -->
        ...
        /**
         * Creates a new adapter for an object of class '{@link eu.mondo.map.tests.model.emf.network.Node <em>Node</em>}'.
         * <!-- begin-user-doc -->
         * This default implementation returns null so that we can easily ignore cases;
         * it's useful to ignore a case when inheritance will catch all the cases anyway.
         * <!-- end-user-doc -->
