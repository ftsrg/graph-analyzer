...
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.ASSOCIATION;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.CATEGORY;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.DAYS;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.DESTINATIONS;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.END_DATE;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.INDICATOR_C;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.INDICATOR_N;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.INDICATOR_O;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.INDICATOR_P;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.LOCATION;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.NEIGHBORS;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.ORIGIN;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.PERMANENT;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.PLANNING;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.SCHEDULE;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.SCHEDULES;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.SHORTTERM;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.START_DATE;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.STATION;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.STATUS;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.STP_INDICATOR;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.TERMINAL;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.TRAIN;
...
import eu.mondo.map.hg.constants.schedule.ScheduleModelConstants;
import eu.mondo.map.hg.constants.schedule.ScheduleSubmodels;
...
import eu.mondo.map.hg.generator.util.RandomElementsProvider;
...
public abstract class ScheduleGenerator extends SyntheticGenerator {
	...
	protected int getDestinationsNumber() {
		double exponent = -3.0;
		double x0 = 2.0;
		double x1 = generatorConfig.getSize() * 7;
		if (x1 > stations.size()) {
			x1 = stations.size() / 2;
		}
		int x = 0;
