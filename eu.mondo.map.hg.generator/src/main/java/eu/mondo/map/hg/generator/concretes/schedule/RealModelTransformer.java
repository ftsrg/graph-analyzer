...
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.ASSOCIATIONS;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.ASSOCIATIVE;
...
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.TIPLOC_CODE;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.TRAIN;
import static eu.mondo.map.hg.constants.schedule.ScheduleModelConstants.TRAIN_UID;
