...
package eu.mondo.map.hg.benchmark.sesame.analyzer;
...
public class SesameModelDescription extends ModelDescription {

	protected RDFBenchmarkConfig benchmarkConfig;
	protected SesameDriver driver;
	...
	private void initQueries() {
		String queryPath = benchmarkConfig.getWorkspacePath()
				+ "/eu.mondo.map.hg.benchmark.rdf/src/main/resources/queries/util/";
