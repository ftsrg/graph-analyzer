 ...
 *******************************************************************************/
package eu.mondo.map.hg.benchmark.sesame.driver;
	...
	public List<SesameMatch> runQuery(final Query query, final String queryDefinition)
		...
		try {
			while (queryResults.hasNext()) {
				...
				System.out.println(bs.getBinding("station1"));
				System.out.println(bs.getBinding("station2"));
				System.out.println(bs.getBinding("station3"));
