...
// shortestPathList.determineRandomPairs(network, numberOfRandomPairs);
//
// Node<N> sourceNode;
// Node<N> targetNode;
...
// }
//
// public void calculate(final Network<N> network, final Node<N> sourceNode,
// final Node<N> targetNode) {
...
// }
//
// protected Set<String> getCheckedDimensions(final Network<N> network, final
// List<Node<N>> nodesInPath,
// final int sourceIndex, final int targetIndex) {
// Set<String> dimensions =
// network.getAdjacency().get(nodesInPath.get(sourceIndex),
...
// throw new IllegalArgumentException("The path size is not acceptable, it is
// lower than 2.");
// }
// return nodesInPath;
// }
