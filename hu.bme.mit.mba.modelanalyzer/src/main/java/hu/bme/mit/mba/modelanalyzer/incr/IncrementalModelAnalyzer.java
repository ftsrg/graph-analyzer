...
public class IncrementalModelAnalyzer extends ModelAnalyzer {
    ...
    @Override
    public <N, T> IncrementalModelAnalyzer evaluate(ModelAdapter adapter) {
        super.evaluate(adapter);
        return this;
    }

    @Override
    public <N, T> IncrementalModelAnalyzer evaluate(ModelAdapter adapter, ModelMetricsEnum metric) {
